  ...
  return (
    <Box sx={{ width: '100%'}} id="workshops_container">
      ...
      <h2 id="jjj_heading">Cultural Activities</h2>
        {
          culturals && culturals.map(index=><ActivityCard2 name={index.name} about={index.about} date={index.date} venue={index.venue} hc={index.hc} email_of_hc={index.email_of_hc} image={index.image} subheading={index.subheading}/>)
        }
      </CustomTabPanel>
